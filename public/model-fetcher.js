...
async function fetchWithProxy(url) {
  ...
  // For Tripo URLs, prefer STL format
  if (url.includes('tripo') && url.includes('mesh.glb')) {
    url = url.replace('mesh.glb', 'mesh.stl');
    console.log('Model fetcher: Converted GLB to STL URL:', url);
  }
